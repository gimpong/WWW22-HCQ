...
def get_hparams_from_config(config):
  ...
  pretraining = len(config['train_sets']) > 1 and config['train_sets'][0]['args']['until_epoch'] > 0
  if pretraining:
  ...
  hparams['vid/num_hidden_layers'] = config['arch']['args']['vid_bert_params']['num_hidden_layers']
  hparams['vid/num_attention_heads'] = config['arch']['args']['vid_bert_params']['num_attention_heads']
  hparams['vid/hidden_dropout'] = config['arch']['args']['vid_bert_params']['hidden_dropout_prob']
  hparams['vid/attention_dropout'] = config['arch']['args']['vid_bert_params']['attention_probs_dropout_prob']
  hparams['vid/max_position_embeddings'] = config['arch']['args']['vid_bert_params']['max_position_embeddings']
  ...
  if use_txt_bert and 'txt_bert_params' in config['arch']['args']:
    hparams['txt/hidden_dropout'] = config['arch']['args']['txt_bert_params']['hidden_dropout_prob']
    hparams['txt/attention_dropout'] = config['arch']['args']['txt_bert_params']['attention_probs_dropout_prob']

  hparams['keep_missing_modalities'] = config['arch']['args']['keep_missing_modalities']
  ...
  for data_dic in config['train_sets'] + config['continuous_eval_sets'] + config['final_eval_sets']:
  ...
  if config['loss']['type'] == "HybridContrastiveLoss":
    hparams['loss/name'] = "HybridContrastiveLoss"
    hparams['loss/cls_loss_weight'] = config['loss']['args']['cls_loss_weight']
    hparams['loss/vlad_loss_weight'] = config['loss']['args']['vlad_loss_weight']
    hparams['loss/cls_loss/t2v_temp'] = config['loss']['args']['cls_loss_hparams']['t2v_temperature']
    hparams['loss/cls_loss/v2t_temp'] = config['loss']['args']['cls_loss_hparams']['v2t_temperature']
    hparams['loss/vlad_loss/t2v_temp'] = config['loss']['args']['vlad_loss_hparams']['t2v_temperature']
    hparams['loss/vlad_loss/v2t_temp'] = config['loss']['args']['vlad_loss_hparams']['v2t_temperature']
    hparams['loss/vlad_loss/t2v_debias'] = config['loss']['args']['vlad_loss_hparams']['t2v_debias_prior']
    hparams['loss/vlad_loss/v2t_debias'] = config['loss']['args']['vlad_loss_hparams']['v2t_debias_prior']
  hparams['batch_size'] = config['train_sets'][0]['args']['batch_size']
  hparams['max_samples_per_epoch'] = config['trainer']['max_samples_per_epoch']
  hparams['max_text_words'] = config['train_sets'][0]['args']['mix'][0]['max_text_words']
